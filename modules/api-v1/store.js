...
/**
 * Tiny durable store for the client layer: atomic JSON documents and
 * append-only JSONL logs under DOCA_DATA_DIR (default <repo>/.doca).
 *
...
/** Sub-directory helper (media, outbox, artifacts…). */
