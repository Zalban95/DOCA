...
**Phase 1 built in v2.75.0; phase 2 in v2.76.0; phase 3 in v2.77.0** (checkpoints: `modules/projects/checkpoints.js`); **phase 4 in v2.78.0** (`specialists/*.md` shipped, local overrides, promote); **skills in v2.82.0** (`modules/harness/skills.js`, the `skills` kit) — `agents/markdown.js`
